...
public class Activity3 extends AppCompatActivity{
    ...
    public void start(){
        ...
        if(No ==list.size()){//当100道题答题完毕,即退回至首页
            Intent intent = new Intent(Activity3.this, ListeningAEndActivity.class);
    ...
    private void toBandB() {
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                startActivity(new Intent(Activity3.this,ActivityBandB.class));
            }
                        ...
                        public void run() {
                            ...
                            if (duration - currentPosition < 500) {
                                ...
                                if (score == 1) {
                                    ...
                                    if (Util.No_true == Util.No_) {
                                        AlertDialog.Builder dialog = new AlertDialog.Builder(Activity3.this);
                                        dialog.setTitle("You have correctly did 25 Band A questions,do you wish to continue?").
